...
print("Out of 483 activities, {} had matches.".format(count_success))
print("***Finished SNOMED***\n")

#TODO if SNOMED search result == null, search UMLS / LOINC / ICD10 etc. 
...
test_set_list = ['Referred request for NIPT', 'Local request for NIPT', 'NIPT plain reporting test coversheet', 'Troubleshooting request data sent back for the referring lab to action'
